...
export function SiteHeader() {
  return (
    <>
      ...
      <header className="relative z-20 hidden border-b border-white/[0.06] bg-slate-950/40 backdrop-blur-sm sm:block">
      ...
      {/* Mobile-only sticky bottom bar with GitHub button */}
      <div className="fixed bottom-0 left-0 right-0 z-50 flex items-center justify-center border-t border-white/[0.06] bg-slate-950/80 px-4 py-3 backdrop-blur-sm sm:hidden">
        <GitHubButton />
      </div>
    </>
  );
